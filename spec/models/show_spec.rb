...
describe Show do
  ...
  describe "template" do
    ...
    it "should use associated template if exists" do
      @show.stub :real_template => stub_model(Template)
      @show.template.should == @show.real_template
    end

    it "should use #default_template if no associated" do
      @show.stub :default_template => stub_model(Template)
  ...
  describe "#audiobank_enabled?" do
    ...
    it "should be true if audiobank_project is defined" do
      @show.stub :audiobank_project => double
...
describe Show::LiquidDropClass do
  ...
  describe "itpc_url_for_podcast" do
    ...
    it "should return an itpc url with podcast path" do
      @liquid_drop.stub :url_for_podcast => "http://path/to/podcast"
